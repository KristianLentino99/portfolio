...
- `attack-on-titan.webp`: About shelf cover.
- `naruto.webp`: About shelf cover.
- `one-piece.webp`: About shelf cover.

WebP or AVIF is preferred. Keep each display image below roughly 300 KB where practical.
